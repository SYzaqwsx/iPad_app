...
import dao.TerminalIbsDao;
import dto.Terminal_ibs_dto;

@WebServlet("/TerminalServlet_ibs")
public class TerminalServlet_ibs extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        System.out.println("=================================");
        System.out.println("[TerminalServlet_ibs] START");
        ...
        try {
            ...
            TerminalIbsDao dao = new TerminalIbsDao();
            ...
            req.getRequestDispatcher("/WEB-INF/jsp/terminal_ibs.jsp")
                    .forward(req, resp);
            ...
            System.out.println("[TerminalServlet_ibs] END (" + took + " ms)");
            System.out.println("=================================");
        }
    }
